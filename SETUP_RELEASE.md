...
| What | Why |
|---|---|
| PyPI account + 2FA | Required to own and publish the `securedblink` package |
...
runs the `release.yml` workflow in the `paulushcgcj/securedblink` repository."
...
5. Fill in the form with **exactly** these values:
   ...
   | Field | Value |
   |---|---|
   | PyPI Project Name | `securedblink` |
   | Owner | `paulushcgcj` |
   | Repository name | `securedblink` |
...
1. Log in to [https://pypi.org](https://pypi.org).
2. Click your username → **Your projects** → click `securedblink`.
...
git clone https://github.com/paulushcgcj/securedblink.git
cd securedblink
...
uv run securedblink --help

# Build the distribution packages
uv build
# Expected output:
#   dist/securedblink-<version>.tar.gz
#   dist/securedblink-<version>-py3-none-any.whl
...
# 2. Set the version in pyproject.toml, then commit
...
**Fix:** Choose a different name in `pyproject.toml → [project] name`, update
...
| Resource | URL |
|---|---|
| PyPI project page | `https://pypi.org/project/securedblink/` |
| PyPI publishing settings (account) | `https://pypi.org/manage/account/publishing/` |
| PyPI publishing settings (project) | `https://pypi.org/manage/project/securedblink/settings/publishing/` |
| TestPyPI project page | `https://test.pypi.org/project/securedblink/` |
| GitHub Actions runs | `https://github.com/paulushcgcj/securedblink/actions` |
| GitHub Environments | `https://github.com/paulushcgcj/securedblink/settings/environments` |
