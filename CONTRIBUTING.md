...
git clone git@github.com:<your-username>/securedblink.git
cd securedblink
...
```bash
# Direct run
DB_LOCAL=sqlite:///./test.db uv run securedblink
...
securedblink is licensed under [GPL-3.0](LICENSE). By contributing, you agree that
